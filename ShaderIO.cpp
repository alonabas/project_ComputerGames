...
GLuint programManager::createProgram(std::string program_id,
	...
	shaderList.push_back(
			ShaderIO::LoadShader(GL_VERTEX_SHADER, vertex_shader_filename));
	shaderList.push_back(
			ShaderIO::LoadShader(GL_FRAGMENT_SHADER, fragment_shader_filename));
	shaderList.push_back(
			ShaderIO::LoadShader(GL_GEOMETRY_SHADER, geometry_shader_filename));
